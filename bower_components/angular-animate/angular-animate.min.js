...
(function (G, d, P) {
    ...
    d.module("ngAnimate", ["ng"]).directive("ngAnimateChildren",function () {
        ...
        var p = d.noop, x = d.forEach, Q = k.$$selectors, aa = 1, g = "$$ngAnimateState", ga = "$$ngAnimateChildren", I = "ng-animate", h = {running: !0};
        H.decorator("$animate", ["$delegate", "$injector", "$sniffer", "$rootElement", "$$asyncCallback", "$rootScope", "$document", function (w, G, $, J, K, l, P) {
            ...
            function M(a, b, c) {
                function f(a, b) {
                    ...
                    if (c || d)return"leave" == b && (d = c, c = null), l.push({event: b, fn: c}), m.push({event: b, fn: d}), !0
                }
                ...
                var g = a[0];
                if (g) {
                    var n = "setClass" == b, k = n || "addClass" == b || "removeClass" == b, r, E;
                    ...
                    if (T(h)) {
                        ...
                        return{node: g, event: b, className: c, isClassBased: k, isSetClassOperation: n, before: function (a) {
                            u = a;
                            e(m, y,
                                function () {
                                    u = p;
            ...
            function F(a, b, c, f, e, s, n) {
                ...
                if (m) {
                    ...
                    var v = c.data(g) || {};
                    e = v.active || {};
                    var p = v.totalActive || 0, B = v.last, C;
                    m.isClassBased && (C = v.running || v.disabled || B && !B.isClassBased);
                    if (C || N(c, f))u(), r(), l(), y(); else {
                        f = !1;
                        if (0 < p) {
                            C = [];
                            if (m.isClassBased)"setClass" == B.event ? (C.push(B), A(c, b)) : e[b] && (w = e[b], w.event == a ? f = !0 : (C.push(w), A(c, b))); else if ("leave" == a && e["ng-leave"])f = !0; else {
                        ...
                        if (f)u(), r(), l(), k(); else {
                            ...
                            p++;
                            e[b] = m;
                            c.data(g, {last: m, active: e, index: t, totalActive: p});
                            r();
                            m.before(function (e) {
                                var d =
                                    c.data(g);
            ...
            function U(a) {
                if (a = e(a))a = d.isFunction(a.getElementsByClassName) ? a.getElementsByClassName(I) : a.querySelectorAll("." + I), x(a, function (a) {
                    a = d.element(a);
        ...
        k.register("",
            ["$window", "$sniffer", "$timeout", "$$animateReflow", function (g, h, k, J) {
                function K() {
                    L || (L = J(function () {
                        S = [];
                        L = null;
                ...
                function I(a, b) {
                    ...
                    if (!c) {
                        ...
                        c = {total: 0, transitionPropertyStyle: k, transitionDurationStyle: Z, transitionDelayStyle: h, transitionDelay: d, transitionDuration: e, animationDelayStyle: Y, animationDelay: l, animationDuration: f};
                        b && (t[b] = c)
                    }
                    return c
                }
                ...
                function U(a, b, c, d) {
                    ...
                    b.data(v, {running: k.running || 0, itemIndex: l,
                        stagger: h, timings: m, closeAnimationFn: p});
                ...
                function V(a, b, c, d) {
                    ...
                    if (-1 != k.getAttribute("class").indexOf(c) && a) {
                        ...
                        var m = a.stagger, n = a.timings, p = a.itemIndex, r = Math.max(n.transitionDuration, n.animationDuration), u = Math.max(n.transitionDelay, n.animationDelay),
                            y = u * ba, z = Date.now(), w = E + " " + H, q = "", t = [];
                        if (0 < n.transitionDuration) {
                            var A = n.transitionPropertyStyle;
                            -1 == A.indexOf("all") && (q += s + "transition-property: " + A + ";", q += s + "transition-duration: " + n.transitionDurationStyle + ";", t.push(s + "transition-property"), t.push(s + "transition-duration"))
                        }
                        0 < p && (0 < m.transitionDelay && 0 === m.transitionDuration && (q += s + "transition-delay: " + T(n.transitionDelayStyle, m.transitionDelay, p) + "; ", t.push(s + "transition-delay")), 0 < m.animationDelay && 0 === m.animationDuration && (q += s + "animation-delay: " +
                            T(n.animationDelayStyle, m.animationDelay, p) + "; ", t.push(s + "animation-delay")));
                ...
                var s = "", n, H, r, E;
                G.ontransitionend === P && G.onwebkittransitionend !== P ? (s = "-webkit-",
                    n = "WebkitTransition", H = "webkitTransitionEnd transitionend") : (n = "transition", H = "transitionend");
                ...
                var Q = "Duration", u = "Property", y = "Delay", m = "IterationCount", z = "$$ngAnimateKey", v = "$$ngAnimateCSS3Data", ca = "ng-animate-block-transitions", B = 3, C = 1.5, ba = 1E3, t = {}, da = 0, S = [], L, ea = null, fa = 0, X = [];
